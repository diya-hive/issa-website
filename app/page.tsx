  ...
  return (
    <div className="flex flex-col">
      <section className="flex w-screen h-screen bg-[url('/LandingHero.png')] bg-cover">
        <div className="flex flex-col w-full h-full items-start mt-24 md:mt-24 md:ml-16 gap-4 p-4">
      ...
      <section className="flex flex-col w-screen lg:h-screen bg-white pt-6 pb-6">
        ...
        <div className="flex flex-col md:flex-row w-full h-1/3 gap-6 md:gap-16 items-center justify-center text-iblue p-4 md:p-8">
          <div className="flex flex-col items-center font-montesserat-bold text-4xl md:text-5xl lg:text-7xl">
            <CountUp
              start={0}
              end={35}
              duration={3}
      ...
      <section className="w-screen bg-iblue flex flex-col pt-6 pb-6">
        <p className="font-montesserat-bold text-white text-4xl p-8">
          OUR PRODUCTS
        </p>
        <ProductCarousel />
        <Link href="/gallery" className="border-1 w-64 py-2 rounded self-center text-white font-montesserat text-center">Explore</Link>
      </section>
      <section className="w-screen flex flex-col bg-white bg-[url('/BgIssa.jpg')] bg-contain bg-no-repeat bg-right">
        <p className="font-montesserat-bold text-4xl text-iblue p-8">
