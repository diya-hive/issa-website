          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="p-6">
              <nav className="flex flex-col gap-4 text-sm font-montesserat items-center">
                <a href="/" onClick={handleSheetClose}>
                  <img
                    src="/Group18.png"
                ...
                <Link href="/about" onClick={handleSheetClose}>
                  About Us
                </Link>
                <Link href="/products" onClick={handleSheetClose}>
                  Products
                </Link>
                <Link href="/blog" onClick={handleSheetClose}>
                  Blog
                </Link>
